        ...
        <ul class="nav navbar-nav pull-right">
                        ...
                        <div class="box dark">
                            <div class="box p-a scrollable maxHeight320">
                                <ul class="list-group list-group-gap m-a-0">
                                    <?php $__currentLoopData = $webmailsAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webmailsAlert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $eventsAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventsAlert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item lt box-shadow-z0 b">
                                    <span class="clear block">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu pull-right dropdown-menu-scale">
                            ...
                            <a class="dropdown-item"
                               href="<?php echo e(route('webmails')); ?>"><span><?php echo e(__('backend.siteInbox')); ?></span>
                                <?php if( @$webmailsNewCount >0): ?>
                                    <span class="label warn m-l-xs"><?php echo e(@$webmailsNewCount); ?></span>
                                <?php endif; ?>
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    <a class="dropdown-item" href="<?php echo e(url('/logout')); ?>"><?php echo e(__('backend.logout')); ?></a>
                </div>
            </li>
...
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/layouts/header.blade.php ENDPATH**/ ?>