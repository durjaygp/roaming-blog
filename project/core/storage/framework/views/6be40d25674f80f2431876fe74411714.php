                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="alert alert-warning m-b-0">
                                    ...
                                    <i class="fa fa-info-circle"></i> <?php echo __('backend.savePageToUseDragAndDropEditor'); ?>

                                    &nbsp;
                                    <button type="submit" class="btn btn-xs btn-warning"><i
                                            class="fa fa-save"></i> <?php echo __('backend.save'); ?></button>
                                </div>
                            </div>
                        </div>
                        <?php $__currentLoopData = Helper::languagesList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ActiveLanguage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($cf_land_active): ?>
                                            ...
                                            <div class="m-t-sm">
                                                <label class="md-check">
                                                    <input type="radio" value="<?php echo e($line_num); ?>"
                                                           ...
                                                           <?php echo e(($customField->default_value == $line_num) ? "checked":""); ?> class="has-value">
                                                    <i class="blue"></i>
                            ...
                            <?php elseif($customField->type ==14): ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="md-check">
                                            <input type="checkbox" name="<?php echo e('customField_'.$customField->id); ?>"  value="1"
                    ...
                    <?php if($WebmasterSection->case_status): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        <?php echo Form::radio('status','1',true, array('id' => 'status1','class'=>'has-value')); ?>
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        <?php echo Form::radio('status','0',false, array('id' => 'status2','class'=>'has-value')); ?>
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/topics/create.blade.php ENDPATH**/ ?>