...
<?php $__env->startPush("after-scripts"); ?>
    <script>
        let applyLabel= '<?php echo e(__('backend.apply')); ?>',
            fromLabel= '<?php echo e(__('backend.applyFrom')); ?>',
            toLabel= '<?php echo e(__('backend.applyTo')); ?>',
            cancelLabel= '<?php echo e(__('backend.cancel')); ?>',
                ...
                initDashboardDaterange: function () {
                    ...
                    $('#dashboard-report-range').daterangepicker({
                            ...
                            locale: {
                                ...
                                toLabel: '<?php echo e(__('backend.applyTo')); ?>',
                                customRangeLabel: '<?php echo e(__('backend.customRange')); ?>',
                                firstDay: <?php echo e((env("FIRST_DAY_OF_WEEK",0)+1)); ?>
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/analytics/list.blade.php ENDPATH**/ ?>