<script src="<?php echo e(url('/assets/js/jquery-3.7.1.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('/assets/js/main.min.js')); ?>"></script>
    <script>
      ...
      $(document).ready(function() {
        ...
        $('#searchInput').on('input', function () {
            ...
            if ($(this).val().length === 0) {
                ...
                $(this).attr('placeholder', '<?php echo e(__('frontend.Enter_Letters')); ?>');
            }
        });
...
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/frontEnd/includes/kelifooter.blade.php ENDPATH**/ ?>