                    ...
                    <div class="text-center">
                        <div>
                            ...
                            <h1 class="heading4" id="headingCustumized">
                                ...
                                <?php else: ?>
                                    <?php echo e(__('frontend.homeHeader')); ?>

                                <?php endif; ?>
                            </h1>
                        </div>
                        <div class="body2 mt-16"><?php echo e(__('frontend.homeSubHeader')); ?></div>
                        <br>
                        <form action="<?php echo e(route('kelimebulucu')); ?>" method="get" id="myform">
                            <!-- <?php echo csrf_field(); ?> -->
                            <div class="input-group">
                                <input class="form-control  rounded-pill input-mysize" type="search" id="searchInput" name="harfler" minlength="2" placeholder="<?php echo e(__('frontend.Enter_Letters')); ?>" id="example-search-input" autocomplete="off" style="text-align: center;  color: #000000; font-weight:bold; height:60px; " >
                                        ...
                                        <div class="col-md-3 col-sm-6 col-6 mt-2">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-group flex-grow-1">
                                                    ...
                                                    <label for="uzunluk" class="text-uppercase" style="color: black"><?php echo e(__('frontend.lenght')); ?></label>
                                                </div>
                                                <span class="input-group-append">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class=" d-flex">
                                    ...
                                    <div class="mt-40 ms-auto me-auto">
                                        <button type="submit" id="searchButton" class="btn btn-success btn-lg btn-block btnsearch fw-bold"><?php echo e(__('frontend.search')); ?></button>
...
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/frontEnd/includes/MainForm.blade.php ENDPATH**/ ?>