<meta charset="utf-8">
<title><?php echo e((@$PageTitle !="")? @$PageTitle:Helper::GeneralSiteSettings("site_title_" . @Helper::currentLanguage()->code)); ?></title>
...
<link href="<?php echo e(URL::asset('assets/frontend/css/fancybox/jquery.fancybox.css')); ?>?v=<?php echo e(Helper::system_version()); ?>" rel="stylesheet">
<link href="<?php echo e(URL::asset('assets/frontend/css/jcarousel.css')); ?>?v=<?php echo e(Helper::system_version()); ?>" rel="stylesheet"/>
<link href="<?php echo e(URL::asset('assets/frontend/css/flexslider.css')); ?>?v=<?php echo e(Helper::system_version()); ?>" rel="stylesheet"/>

<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/css/bootstrap-select.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>">
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/css/horizontal-timeline.css')); ?>?v=<?php echo e(Helper::system_version()); ?>">
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/css/select2.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>"/>
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/css/select2-bootstrap.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>"/>
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/css/bootstrap-datetimepicker.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>"/>

<link href="<?php echo e(URL::asset('assets/frontend/css/style.css')); ?>?v=<?php echo e(Helper::system_version()); ?>" rel="stylesheet"/>
<link href="<?php echo e(URL::asset('assets/frontend/css/color.css')); ?>?v=<?php echo e(Helper::system_version()); ?>" rel="stylesheet"/>
<link href="<?php echo e(URL::asset('assets/frontend/css/colors.css')); ?>?v=<?php echo e(Helper::system_version()); ?>" rel="stylesheet"/>
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/js/owl-carousel/assets/owl.carousel.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>">
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/frontend/js/owl-carousel/assets/owl.theme.default.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>">
...
<meta property='og:title'
      content='<?php echo e(@$PageTitle); ?> <?php echo e((@$PageTitle =="")? Helper::GeneralSiteSettings("site_title_" . @Helper::currentLanguage()->code):""); ?>'/>
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/frontEnd/includes/head.blade.php ENDPATH**/ ?>