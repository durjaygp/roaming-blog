            ...
            <div class="row">
                <div class="col-lg-<?php echo e((count($Categories)>0)? "8":"12"); ?>">
                    ...
                    <article>
                                    ...
                                    <?php if($Topic->video_type ==1): ?>
                                        ...
                                        <?php if($Youtube_id !=""): ?>
                                            ...
                                            <iframe allowfullscreen
                                                    src="https://www.youtube.com/embed/<?php echo e($Youtube_id); ?>?autoplay=1&mute=1"
                                                    allow="autoplay">
                                            </iframe>
                                        <?php endif; ?>
                        ...
                        <?php else: ?>
                                <?php
                                $i = str_contains($Topic->$details,"{{MAIN_FORM_PLACEHOLDER}}");
                                ?>
                            <?php if($i != 1): ?>
                                <div class="post-image">
                                    ...
                                    <?php if($Topic->photo_file != ""): ?>
                                        <img src="<?php echo e(URL::to('uploads/topics/'.$Topic->photo_file)); ?>" alt="<?php echo e($title); ?>" title="<?php echo e($title); ?>"/>
                                        <br>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
    ...
    <?php echo $cf_saved_val; ?></span>
                                                    ...
                                                    <?php elseif($customField->type ==1): ?>
                                                        ...
                                                        <div class="row field-row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <?php echo Helper::ParseLinks(nl2br($cf_saved_val)); ?>
                        ...
                        <?php endif; ?>
                            ...
                            <?php
                            $title= $Topic->seo_title_tr;
                            $mainFormContent = view('frontEnd.includes.MainForm',compact('title'));
                            // Replace the placeholder with the actual content
                            $htmlString = str_replace('{{MAIN_FORM_PLACEHOLDER}}', $mainFormContent, $Topic->$details);
                            $htmlString = str_replace("ADS_GOOGLE", '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4691302050848766"
...
<script>(adsbygoogle = window.adsbygoogle || []).push({});
                        ...
                        <?php endif; ?>
                        <!-- <?php if($WebmasterSection->type == 7): ?>
                                <a href="<?php echo Helper::sectionURL($Topic->webmaster_id); ?>" class="btn btn-default w-100" style="width: 100%"><i class="fa fa-reply"></i> <?php echo e(__('backend.clickToNewSearch')); ?></a>
                        <?php else: ?>
                            <div class="bottom-article">
                                <ul class="meta-post">
                                ...
                                <div class="pull-right">
                                    ...
                                    <ul class="social-network share">
                                        ...
                                        <li><a href="<?php echo e(Helper::SocialShare("whatsapp", $PageTitle)); ?>" class="twitter"
                        ...
                        <?php if(@$Topic->form_id >0): ?>
                            <br>
                            <div>
                                <?php echo $__env->make('frontEnd.form',["FormSectionID"=>@$Topic->form_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        <?php elseif($WebmasterSection->order_status): ?>
                            <div id="order">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <br>
...
<?php echo $__env->make('frontEnd.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/frontEnd/topic.blade.php ENDPATH**/ ?>