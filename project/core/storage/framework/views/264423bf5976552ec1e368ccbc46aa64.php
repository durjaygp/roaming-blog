<?php if($WebmasterSection->type != 4): ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div>
                                        <label><?php echo __('backend.topicSEOTitle'); ?></label> <?php echo @Helper::languageName($ActiveLanguage); ?>


                                        <?php echo Form::text('seo_title_'.@$ActiveLanguage->code,$Topics->{'seo_title_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_title_'.@$ActiveLanguage->code,'maxlength'=>'65', 'dir'=>@$ActiveLanguage->direction)); ?>

                                    </div>
                                </div>
                                <div class="form-group">
                                    <div>
                                        <label><?php echo __('backend.friendlyURL'); ?></label> <?php echo @Helper::languageName($ActiveLanguage); ?>


                                        <?php echo Form::text('seo_url_slug_'.@$ActiveLanguage->code,$Topics->{'seo_url_slug_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_url_slug_'.@$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction)); ?>
                                ...
                                <div class="form-group">
                                    <div>
                                        <label><?php echo __('backend.topicSEODesc'); ?></label> <?php echo @Helper::languageName($ActiveLanguage); ?>


                                        <?php echo Form::textarea('seo_description_'.@$ActiveLanguage->code,$Topics->{'seo_description_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_description_'.@$ActiveLanguage->code,'maxlength'=>'165', 'dir'=>@$ActiveLanguage->direction,'rows'=>'2')); ?>
                                ...
                                <div class="form-group">
                                    <div>
                                        <label><?php echo __('backend.topicSEOKeywords'); ?></label> <?php echo @Helper::languageName($ActiveLanguage); ?>


                                        <?php echo Form::textarea('seo_keywords_'.@$ActiveLanguage->code,$Topics->{'seo_keywords_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_keywords_'.@$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction,'rows'=>'2')); ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/topics/tabs/seo.blade.php ENDPATH**/ ?>