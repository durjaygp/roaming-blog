<?php if(@Auth::user()->permissionsGroup->add_status): ?>
    <div id="record-import" class="modal fade" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <?php echo e(Form::open(['route'=>['topicsImport'],'method'=>'POST','id'=>'record-import-form', 'files' => true])); ?>

                <div class="modal-header">
                    <h5 class="modal-title"><i
                            class="material-icons">&#xe2c6;</i> <span
                            class="modal-box-title"><?php echo __('backend.importData'); ?></span>
                    </h5>
                        ...
                        <div class="p-a-2">
                            <div class="row">
                                <div class="col-sm-6 text-center text-success">
                                    ...
                                    <h5> <?php echo e(__("backend.importedCount")); ?></h5>
                                </div>
                                <div class="col-sm-6 text-center text-danger">
                                    <h3 id="report_failed_count">0</h3>
                                    <h5> <?php echo e(__("backend.notImportedCount")); ?></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="section_id" value="<?php echo e(encrypt(@$WebmasterSection->id)); ?>"/>
                    <button type="button" class="btn dark-white p-x-md"
                            data-dismiss="modal"><?php echo __('backend.cancel'); ?>

                    </button>
                    <button type="submit" id="record-import-form-submit" class="btn info p-x-md pull-left"><i
                            class="material-icons">&#xe31b;</i> <?php echo __('backend.continue'); ?>
    ...
    <script>
        $("#import_btn").click(function () {
            ...
            $("#from_row").val("0");
            $("#record-import .form-fields").html("<div class=\"text-center p-a-2\"><img class=\"m-b-1\" src=\"<?php echo e(asset('assets/dashboard/images/loading.gif')); ?>\" style=\"height: 35px;\"/><div class='text-muted small'><?php echo e(__("backend.loading")); ?></div></div>");
            ...
            var xhr = $.ajax({
                ...
                data: {
                    ...
                    section_id: '<?php echo e(encrypt(@$WebmasterSection->id)); ?>',
                    step: 0,
                },
        ...
        function send_next_request() {
            ...
            var xhr = $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#record-import-form-submit').html("<i class=\"material-icons\">&#xe31b;</i> <?php echo __('backend.continue'); ?>");
                    $('#record-import-form-submit').prop('disabled', false);
                }
            });
            console.log(xhr);
        ...
        $('#record-import-form').submit(function (evt) {
            evt.preventDefault();
            $('#record-import-form-submit').html("<img src=\"<?php echo e(asset('assets/dashboard/images/loading.gif')); ?>\" style=\"height: 20px\"/> <?php echo __('backend.add'); ?>");
            $('#record-import-form-submit').prop('disabled', true);
                ...
                success: function (result) {
                    ...
                    if (result.stat === 'success') {
                        if (result.step === 2) {
                            ...
                            $("#fields_import_process").html("<div class='p-a m-b text-center h6'><img src=\"<?php echo e(asset('assets/dashboard/images/loading.gif')); ?>\" style=\"height: 25px\"/> <?php echo __('backend.importLoading'); ?></div>");
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/topics/import/modal.blade.php ENDPATH**/ ?>