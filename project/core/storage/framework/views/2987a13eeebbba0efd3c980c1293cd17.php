...
<?php $__env->startSection('content'); ?>
    <div class="center-block w-xxl p-a-2">
        <div class="p-a-md box-color r box-shadow-z4 text-color m-b-0">
            ...
            <form name="form" method="POST" action="<?php echo e(url('/'.env('BACKEND_PATH').'/login')); ?>" onsubmit="document.getElementById('login_form_submit').disabled = true; return true;">
...
<?php echo $__env->make('dashboard.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/auth/login.blade.php ENDPATH**/ ?>