        ...
        <div class="box">
            ...
            <div class="box-tool">
                <ul class="nav">
                    ...
                    <?php endif; ?>
                    <li class="nav-item inline">
                        <button type="button" class="btn info" id="filter_btn" title="<?php echo e(__('backend.search')); ?>"
                                data-toggle="tooltip">
                            <i class="fa fa-search"></i>
                        </button>
                    </li>
                    <?php if(@Auth::user()->permissionsGroup->add_status): ?>
                        <button type="button" class="btn accent" id="import_btn" title="<?php echo e(__('backend.import')); ?>"
                                data-toggle="tooltip">
                            <i class="fa fa-upload"></i>
                        </button>
                    <?php endif; ?>
                    <li class="nav-item inline">
                        <button type="button" class="btn warn" id="print_btn" title="<?php echo e(__('backend.print')); ?>"
                                data-toggle="tooltip" onclick="print_as('print')">
                            <i class="fa fa-print"></i>
                        </button>
                    </li>
                    <li class="nav-item inline">
                        <button type="button" class="btn success" id="excel_btn" title="<?php echo e(__('backend.export')); ?>"
                                data-toggle="tooltip"
                        ...
                        <div class="filter_div">
                            <div class="row">
                                <?php if(count($WebmasterSection->customFields->where("in_search",true))==0): ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if($WebmasterSection->title_status || $WebmasterSection->longtext_status): ?>
                                ...
                                <?php $__currentLoopData = $WebmasterSection->customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($customField->in_search): ?>
                                        ...
                                        <?php if($cf_land_active): ?>
                                            ...
                                            <?php elseif($customField->type ==7 || $customField->type ==6 || $customField->type ==13): ?>
                                                <div class="col-md-3 col-xs-6 m-b-5p">
                                                    <select name="<?php echo e('customField_'.$customField->id); ?>"
                                                            id="<?php echo e('customField_'.$customField->id); ?>"
                                                            class="form-control c-select" <?php echo e($cf_required); ?>>
        ...
        <?php $__currentLoopData = $WebmasterSection->customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($customField->in_statics && ($customField->type==6 || $customField->type==7)): ?>
                <div class="box">
                    ...
                    ?>
                    <div class="chart-area" id="canvas-holder-<?php echo e($customField->id); ?>"
...
<?php $__env->startPush("after-scripts"); ?>
    ...
    <script type="text/javascript">
            ...
            var dataTable = $(table_name).DataTable({
                ...
                "columns": [
                        ...
                        <?php if(@Auth::user()->permissionsGroup->edit_status): ?>
                    {
                        ...
                        <?php endif; ?>
                    {
                        "data": "no", "class": "text-center w-64"
                    },
                        <?php if($WebmasterSection->title_status): ?>
                    {
                        "data": "id"
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (obj_result.stat == 'success') {
                            ...
                            swal({
                                title: "<span class='text-success'><?php echo e(__("backend.deleteDone")); ?></span>",
                                text: "",
                                html: true,
                                type: "success",
        ...
        function print_as(stat) {
            ...
            $("#filter_form").attr('action', '<?php echo e(route("topicsPrint",$WebmasterSection->id)); ?>');
            $("#filter_form").attr('target', '_blank');
            $("#filter_form").submit();
            $("#filter_form").attr('action', '<?php echo e(route("topics",$WebmasterSection->id)); ?>');
            $("#search_submit_stat").val("");
            $("#filter_form").attr('target', '');
        }
    </script>

    <?php echo $__env->make("dashboard.topics.import.modal", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/topics/list.blade.php ENDPATH**/ ?>