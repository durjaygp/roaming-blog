<?php if(Helper::GeneralWebmasterSettings("text_editor") ==2): ?>
    ...
    <script>
        CKEDITOR.editorConfig = function (config) {
            ...
            config.contentsCss = '<?php echo e(URL::asset('assets/frontend/css/bootstrap.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>';
        };
    </script>
<?php elseif(Helper::GeneralWebmasterSettings("text_editor") ==1): ?>
    ...
    <script>
        tinymce.init({
            ...
            content_css: "<?php echo e(URL::asset('assets/frontend/css/bootstrap.min.css')); ?>?v=<?php echo e(Helper::system_version()); ?>",
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/kelimelodi.com/new.kelimelodi.com/core/resources/views/dashboard/layouts/editor.blade.php ENDPATH**/ ?>