...
//order, paginate
        ...
        if ($totalFiltered > 0) {
            ...
            foreach ($Topics as $Topic) {
                ...
                $edit_btn .= "<a class=\"btn btn-sm light b-a\"
    ...
    public function store(Request $request, $webmasterId)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            $this->validate($request, [
                'photo_file' => 'mimes:png,jpeg,jpg,gif,svg,webp',
            ...
            if ($request->$formFileName != "") {
                $fileFinalName = $request->file($formFileName)->getClientOriginalName();
