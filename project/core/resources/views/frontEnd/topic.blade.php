                        ...
                        @else
                            ...
                            @if($i != 1)
                                <div class="post-image">
                                    ...
                                    @if($Topic->photo_file != "")
                                        <img src="{{ URL::to('uploads/topics/'.$Topic->photo_file) }}" alt="{{ $title }}" title="{{ $title }}"/>
                                        <br>
                                    @endif
                                </div>
                            @endif
...
<script>(adsbygoogle = window.adsbygoogle || []).push({});
                        ...
                        <!-- @if($WebmasterSection->type == 7)
                                <a href="{!! Helper::sectionURL($Topic->webmaster_id) !!}" class="btn btn-default w-100" style="width: 100%"><i class="fa fa-reply"></i> {{ __('backend.clickToNewSearch') }}</a>
                        @else
                            <div class="bottom-article">
                                <ul class="meta-post">
                                ...
                                <div class="pull-right">
                                    ...
                                    <ul class="social-network share">
                                        ...
                                        <li><a href="{{ Helper::SocialShare("whatsapp", $PageTitle)}}" class="twitter"
