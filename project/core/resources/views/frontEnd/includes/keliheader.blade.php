...
<link rel="shortcut icon" href="{{ url('assets/images/kelimelodi-kelime-bulucu-favicon.png') }}"/>
<link rel="stylesheet" href="{{ url('assets/css/bootstrap.min.css') }}"/>
{{--<link rel="stylesheet" href="{{ url('assets/css/animate-4.1.1.min.css') }}"/>--}}
{{--<link rel="stylesheet" href="{{ url('assets/css/slick.css') }}"/>--}}
{{--<link rel="stylesheet" href="{{ url('assets/icons/style.css') }}"/>--}}
