...
<div id="content" class="p-0">
                ...
                <div class="div11 p-0" id="divMobile">
                        ...
                        <div class="text-center bg-light p-2 py-3 div16" style="border-radius:10px;">
                            <div class="row mx-2">
                                ...
                                <div class="col heading4 showWeb mt-2" style="line-height: 24px;">
                                    <center>{{ __('frontend.unscramble_Letters') }}</center>
                                </div>
                            </div>
                            <div class="body2" style="margin-top: 2%;font-size: 16px;">{{ __('frontend.unscramble_SubHeader') }}</div>
                            <form action="{{ route('kelimebulucu')}}" method="get" id="myformModal" style="margin-top: 3%">
                                <!-- @csrf -->
                                <div class="input-group" id="InputGroupModal">
                                    <input class="form-control form_control_main rounded-pill input-mysize" type="search" id="searchInputModal" name="harfler" minLength="2" value="{{ $harfler }}" autocomplete="off" id="example-search-input"
                                ...
                                <div class="row justify-content-center">
                                    <div class="row mx-3 mt-2">
                                        <div class="col-md-33 col-sm-6 col-6 mt-2">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-group flex-grow-1">
                                                    <input class="form-control turkish-english-input rounded formInput" type="search" name="baslayan" autocomplete="off" placeholder="A" value="{{ $start }}"  id="startInputModal"
                                        ...
                                        <div class="col-md-33 col-sm-6 col-6 mt-2">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-group flex-grow-1">
                                                    <input class="form-control turkish-english-input rounded formInput" type="search" name="iceren" autocomplete="off" placeholder="A_B" value="{{ $contain }}" id="containInputModal"
                                                           style="text-align: center;  color: #000000; font-weight:bold;height:60px;">
                                        ...
                                        <div class="col-md-33 col-sm-6 col-6 mt-2">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-group flex-grow-1">
                                                    <input class="form-control turkish-english-input rounded formInput" type="search" name="biten" autocomplete="off" placeholder="B" value="{{ $end }}"  id="endInputModal"
                                                           style="text-align: center;  color: #000000; font-weight:bold;height:60px;">
                                        ...
                                        <div class="col-md-33 col-sm-6 col-6 mt-2">
                                            <div class="input-group">
                                                <div class="form-floating form-floating-group flex-grow-1">
                                                    <input class="form-control rounded formInput" type="search" name="uzunluk" min="2" max="70" autocomplete="off" placeholder="LENGTH" value="{{ $length }}" id="lengthInputModal" pattern="\d{1,2}"
                                                           style="text-align: center;  color: #000000; font-weight:bold; height:60px;">
                                                    <label for="uzunluk" class="text-uppercase" style="color: black;margin-top: -4%;">{{ __('frontend.lenght') }}</label>
                                                </div>
                                                <span class="input-group-append">
                                                      <button class="btn bg-white ms-n4 btn-ss popover-trigger-custom" type="button" style="height:55px; margin-top:2px; width:10px; display: flex; align-items: center; justify-content: center;background: transparent; margin-top: -2%"
                                ...
                                <div class="row justify-content-center text-center" style="margin-top: 3%">
                                    <div class="col-md-9 col-sm-6 col-9"> <!-- Adjust the column size based on your layout -->
                                        <button type="submit" id="searchButtonModal" class="btn btn-success btn-lg btn-block fw-bold" style="height:50px;width:100%;font-size: 15px;">{{ __('frontend.search') }}</button>
                                    </div>
                    ...
                    <div class="text-center bg-light p-2 py-3 div16" id="divMobile2" style="border-radius:10px; position: sticky; top: 0%">
                        <div id="HiddenInMobile">
                            ...
                            <div class="body2" style="margin-top: 2%;font-size: 14px;">{{ __('frontend.unscramble_SubHeader') }}</div>
                        </div>
                        <form action="{{ route('kelimebulucu')}}" method="get" id="myform" style="margin-top: 3%">
                            <!-- @csrf -->
                            <div class="input-group" id="InputGroup">
                                <input class="form-control form_control_main rounded-pill input-mysize" type="search" id="searchInput" name="harfler" minLength="2" value="{{ $harfler }}" autocomplete="off" id="example-search-input"
                            ...
                            <div id="HiddenInMobileV">
                                <div class="row d-flex flex-row justify-content-center align-items-center" style="margin-top: 5%">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-6 p-0">
                                        <div class="input-group" style="max-height: 50px; padding-left: 12%; padding-right: 4%">
                                            <div class="form-floating form-floating-group flex-grow-1" style="max-height: 50px">
                                                <input class="form-control turkish-english-input rounded stickyPosition" type="search" name="baslayan" autocomplete="off" placeholder="A" value="{{ $start }}"  id="startInput"
                                                       style="text-align: center;  color: #000000; font-weight:bold; max-height: 50px " >
                                                <label for="baslayan" class="text-uppercase" style="color: black;margin-top: -4%;">{{ __('frontend.starts') }}</label>
                                            </div>
                                            <span class="input-group-append">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-6 p-0">
                                        <div class="input-group" style="max-height: 50px; padding-right: 12%; padding-left: 4%">
                                            <div class="form-floating form-floating-group flex-grow-1" style="max-height: 50px">
                                                <input class="form-control turkish-english-input rounded" type="search" name="iceren" autocomplete="off" placeholder="A_B" value="{{ $contain }}" id="containInput"
                                                       style="text-align: center;  color: #000000; font-weight:bold; max-height: 50px">
                                                <label for="iceren" class="text-uppercase" style="color: black;max-height: 50px;">{{ __('frontend.contains') }}</label>
                                            </div>
                                            <span class="input-group-append">
                                ...
                                <div class="row d-flex flex-row justify-content-center align-items-center" style="margin-top: 5%">
                                    <div class="col-md-6 col-sm-6 col-6 p-0">
                                        <div class="input-group" style="max-height: 50px; padding-left: 12%; padding-right: 4%">
                                            <div class="form-floating form-floating-group flex-grow-1" style="max-height: 50px">
                                                <input class="form-control turkish-english-input rounded" type="search" name="biten" autocomplete="off" placeholder="B" value="{{ $end }}"  id="endInput"
                                                       style="text-align: center;  color: #000000; font-weight:bold;max-height: 50px;">
                                                <label for="biten" class="text-uppercase" style="color: black;max-height: 50px;">{{ __('frontend.ends') }}</label>
                                            </div>
                                            <span class="input-group-append">
                                                      <button class="btn bg-white ms-n4 btn-ss popover-trigger-custom" type="button" style="height:50px; margin-top:2px; width:10px; display: flex; align-items: center; justify-content: center;background: transparent; margin-top: -2%"
                                                              data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content='<p class="text-grey col pr-0">{{ __('frontend.endsDetails') }}</p>' >
                                    ...
                                    <div class="col-md-6 col-sm-6 col-6 p-0">
                                        <div class="input-group" style="max-height: 50px; padding-right: 12%; padding-left: 4%">
                                            <div class="form-floating form-floating-group flex-grow-1" style="max-height: 50px">
                                                <input class="form-control rounded" type="search" name="uzunluk" min="2" max="70" autocomplete="off" placeholder="LENGTH" value="{{ $length }}" id="lengthInput" pattern="\d{1,2}"
                                                       style="text-align: center;  color: #000000; font-weight:bold; text-transform:uppercase;max-height: 50px;">
                                                <label for="uzunluk" class="text-uppercase" style="color: black;max-height: 50px;">{{ __('frontend.lenght') }}</label>
                                            </div>
                                            <span class="input-group-append">
                                                      <button class="btn bg-white ms-n4 btn-ss popover-trigger-custom" type="button" style="height:50px; margin-top:2px; width:10px; display: flex; align-items: center; justify-content: center;background: transparent; margin-top: -2%"
                                                              data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content='<p class="text-grey col pr-0">{{ __('frontend.lenghtDetails') }}</p>' >
                                ...
                                <div class="row justify-content-center text-center" style="margin-top: 5%">
                                    <div class="col-md-9 col-sm-6 col-9"> <!-- Adjust the column size based on your layout -->
                                        <button type="submit" id="searchButton" class="btn btn-success btn-lg btn-block fw-bold" style="height:45px;width:100%;font-size: 15px;">{{ __('frontend.search') }}</button>
                                    </div>
                                    <div class="col-md-3 col-sm-1 col-3"> <!-- Adjust the column size based on your layout -->
                ...
                <div class="col-md-7" id="containerMobileI">
                    <div id="paragraphHiddenInMobile" class="text-left">
                        @if(count($paginator)==0)
                            <p class="fs-5">
                                {{  __('frontend.notFoundText1') }}
                            </p>
                            <p class="fs-6">
                                {{  __('frontend.notFoundText2') }}
                            </p>
                        @endif
                        <h1 class="h3_class">
                            {!! $message !!}
                                ...
                                @foreach ($paginator as $item)
                                    ...
                                    <div class="col-12 mt-1">
                                        <div>
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th colspan="3" id="headerMobile{{$item['key']}}" style="padding-left: 3%;background-color:#{{$item['key']%10}}e662b; color: #ffffff; min-width:200px; position: sticky; top: 2.5%; z-index: 15">{{$item['key']}} {{  __('frontend.letter_word') }}
                                                            <span style="float: right;">{{$item['tot']}} {{  __('frontend.words') }} </span></th>
                                                    </tr>
                                                </thead>
                                                <tbody id="tableBody_">
                                                @foreach ($item['products'] as $product)
                                                    <tr @if($i++>10) style="display:none;" class="tr{{$item['key']}}" @endif >
                                                        <td class="fontMobile">{{ $product->mots }}</td>
                                                        <td class="text-end sizeButton">
                                                            <button type="button" class="btn btn-light popover-trigger heightButtonMobile" style="text-transform: lowercase;"
                                                                    data-bs-toggle="popover" data-bs-placement="bottom" data-word="{{$product->mots}}"
                                                                    data-bs-content='<p class="text-grey" id="meaning"></p>'>
                                                                {{__('frontend.definition')}}
                                                            </button>
                                                        </td>
                                                        <td class="text-end sizeButton">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                    <li class="dropdown-item">
                                                                        <button type="button" class="btn btn-ligth" data-toggle="modal" data-target="#exampleModal">
                                                                            <i class="fa-solid fa-flag"></i> {{ __('frontend.report_invalid_word') }}
                                                                        </button>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            @if($i>10)
                                                <div data-v-46309664="" id="bm{{$item['key']}}" data-v-e1a24138="" class="see-more-container see-more-container--overlay">
                                                    <button style="background:#{{$item['key']%10}}e662b;"  data-v-46309664="" data-testid="{{$item['key']}}" data-tot="{{$item['tot']}}" class="see-more-button"><div data-v-46309664="" class="loading-wrapper" style="display: none;"><img data-v-46309664="" src="/static/images/ico-loading.svg" width="30" height="30" alt="Loading..." class="loading-image"></div> <span data-v-46309664="" data-testid="see_more_button_label">
                                                                        {{ __('frontend.see_more_words') }}
                                                                    </span>
                                                    </button>
                                                </div>

                                                <div data-v-46309664="" id="bl{{$item['key']}}" data-v-e1a24138="" class="d-none see-less-container see-more-container--overlay d-flex flex-row justify-content-center">
                                                    <button style="background:#{{$item['key']%10}}e662b;"  data-v-46309664="" data-testid="{{$item['key']}}" class="see-less-button"><div data-v-46309664="" class="loading-wrapper" style="display: none;"><img data-v-46309664="" src="/static/images/ico-loading.svg" width="30" height="30" alt="Loading..." class="loading-image"></div> <span data-v-46309664="" data-testid="see_more_button_label">
                                                                        {{ __('frontend.see_less_words') }}
                                                                    </span>
                                                    </button>
                                                </div>
                                            @endif
                                    ...
                                    <script>
                                        document.addEventListener("DOMContentLoaded", function() {
                                            const buttonShowMore = document.getElementById('bm{{$item['key']}}');
                                            const buttonShowLess = document.getElementById('bl{{$item['key']}}');

                                            if(buttonShowMore && buttonShowLess){
                                                buttonShowMore.addEventListener('click', function () {
                                                    document.getElementById('show_more_text{{$item['key']}}{{$i}}').style.display = 'block';
                                                    document.getElementById('show_less_text{{$item['key']}}{{$i}}').style.display = 'none';
                                                });

                                                buttonShowLess.addEventListener('click', function () {
                                                    document.getElementById('show_more_text{{$item['key']}}{{$i}}').style.display = 'none';
                                                    document.getElementById('show_less_text{{$item['key']}}{{$i}}').style.display = 'block';
                                                });
                                            }
                                        });
                                    </script>
                                    <p class="pagination d-block">
                                        <span id="show_more_text{{$item['key']}}{{$i}}" style="display: none">{{$i}}/{{$i}} {{ __('frontend.words') }}</span>
                                        @if($i>10)
                                            <span id="show_less_text{{$item['key']}}{{$i}}" style="display:block;">{{($i>10)?'10':$i}} / {{$i}} {{ __('frontend.words') }}</span>
                                        @else
                                            <span id="show_less_text{{$item['key']}}{{$i}}" style="display:block;">{{$i}}/{{$i}} {{ __('frontend.words') }}</span>
                                        @endif
                                    </p>
                                @endforeach
                                    @if(isset($paginator->links))
    ...
    <script>
        ...
        if (window.innerWidth <= 767) {
            ...
            @foreach ($paginator as $item)
            document.getElementById('headerMobile'+'{{$item['key']}}').style.top = '10.9%';
            @endforeach
                ...
                trigger.addEventListener('inserted.bs.popover', async function () {
                    ...
                    try {
                        ...
                        if (response.meaning.length > 0) {
                            ...
                            meaningElement.css("border", "0");
                            meaningElement.css("animation", "none");
                            $("#meaning").html('{{__('frontend.no_definition_found')}}');
                        }
                    } catch (error) {
