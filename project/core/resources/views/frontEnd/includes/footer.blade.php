                                ...
                                <ul class="link-list">
                                    @foreach($FooterMenuLinks as $FooterMenuLink)
                                        ...
                                        @if($FooterMenuLink->type==3 || $FooterMenuLink->type==2)
                                            ...
                                            <li>
                                                <a href="{{ Helper::sectionURL($FooterMenuLink->cat_id) }}">{{ __($link_title) }}</a>
                                            </li>
                                        @elseif($FooterMenuLink->type==1)
                                            ...
                                            ?>
                                            <li>
                                                <a href="{{ $this_link_url }}">{{ __($link_title) }}</a>
                                            </li>
                                        @else
                                             No link
                                            <li><a>{{ __($link_title) }}</a></li>
                                        @endif
                                    @endforeach
                                </ul>
                            </div>
...
{{--                                <div class="col-lg-{{$bx3w}}">--}}
                            ...
                            <div class="widget">
                                    ...
                                    ?>
                                <ul class="link-list">
                                    @foreach($FooterMenuLinks->chunk(ceil(count($FooterMenuLinks)/2))[$counter] as $FooterMenuLink)
                                            <?php
                                            if ($FooterMenuLink->$link_title_var != "") {
                                                $link_title = $FooterMenuLink->$link_title_var;
                                            } else {
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="copyright">
                        ...
                        . <span>{{Helper::GeneralSiteSettings($site_title_var)}}</span>
                    </div>
                </div>
                <div class="col-lg-6">
